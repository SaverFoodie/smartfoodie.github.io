    ...
    <div className="relative bg-[length:100%_100%] bg-center h-[80vh]" style={{ backgroundImage: "url('./machine.png')" }}>
      <div className="flex flex-col items-center justify-center h-full bg-gray-300 bg-opacity-10">
        <div className="ml-[45%]">
          ...
          <br />
          <p className="text-xl text-gray-700 flex items-start before:content-['•'] before:text-[#2A1A1F] before:mr-2 mt-2"> Fully Automated - Built-in steamers prepare fresh and hot meals within just 2 minutes.</p>
          ...
          <p className="text-xl text-gray-700 flex items-start before:content-['•'] before:text-[#2A1A1F] before:mr-2 mt-2"> Optimized Supply Chains - Partnering with local suppliers.</p>
          <p className="text-xl text-gray-700 flex items-start before:content-['•'] before:text-[#2A1A1F] before:mr-2 mt-2"> SmartFoodie App Integration - Users can order, browse menus, and schedule pickups.</p>
