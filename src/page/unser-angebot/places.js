...
const FoodiePlaces = () => {
  ...
  return (
    <div className="relative bg-[length:100%_100%] bg-center h-[80vh]" style={{ backgroundImage: "url('./place1.jpg')" }}>
      <div className="flex flex-col items-center justify-start pt-[18vh] h-full bg-gray-300 bg-opacity-10 px-4 sm:px-6 md:px-8">
        ...
        <br />
        <div className="max-w-8xl w-full md:w-3/4 lg:w-full flex flex-col items-center">
