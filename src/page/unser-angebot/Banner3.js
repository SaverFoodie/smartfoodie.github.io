        ...
        <div className="flex flex-col lg:flex-row justify-center items-center gap-6 lg:gap-10 xl:gap-20 w-full py-4">
          ...
          <div className="flex flex-col justify-center items-center text-center max-w-full lg:max-w-[600px] p-4"> 
            ...
            <ul className="mt-4 md:mt-6 list-none px-4 md:px-6 mb-4 md:mb-5 text-[#222222]">
              <li className="mb-4 md:mb-6 leading-relaxed relative pl-6 text-sm md:text-base lg:text-lg before:content-['•'] before:absolute before:left-0 before:text-[#1a237e]">
